function GL = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   GL = IMPORTFILE(FILENAME)
%   Reads data from text file FILENAME for the default selection.
%
%   GL = IMPORTFILE(FILENAME, STARTROW, ENDROW)
%   Reads data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   GL = importfile('GL.dat', 1, 11103);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2021/12/03 02:16:35
